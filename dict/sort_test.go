...
func TestSortValueLists(t *testing.T) {
	...
	SortValueLists(m)
	tst.AssertListEqual(t, "SortValueLists", m["section1"], []int{82, 87, 90, 93, 95})
	tst.AssertListEqual(t, "SortValueLists", m["section2"], []int{69, 78, 81, 88, 98})
}
...
func TestSortValueListsFunc(t *testing.T) {
	...
	tst.AssertListEqual(t, "SortValueListsFunc", m["section1"], []int{95, 93, 90, 87, 82})
	tst.AssertListEqual(t, "SortValueListsFunc", m["section2"], []int{98, 88, 81, 78, 69})
}
